      ...
      <html> 
         <head>
                <style>
					...
					body {
					background-image: url('background/cafe.gif');
					...
					color:    #b26aa5ff; /* White text color for contrast */
					margin: 0 auto 35px auto; /* Margin at the bottom to space from the table */
					padding: 35px;
					...
					th {
					background-color: #db97d0ff; /* Header background color */
         ...
         <body>
            <div class="center div1">
               ...
               <table border = "1"> 
                  ...
                  <xsl:for-each select="Bryans_Cafe/Menu"> 
                     <tr>
            ...
            <div>
				<audio controls="true" loop="true">
                    <source src="audio/cafe.mp4" type="audio/mpeg" />
                </audio>
            </div>
         </body> 
      </html> 
